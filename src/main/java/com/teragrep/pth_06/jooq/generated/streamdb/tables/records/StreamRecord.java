...
public class StreamRecord extends UpdatableRecordImpl<StreamRecord> implements Record6<UInteger, UInteger, String, String, String, ULong> {

    private static final long serialVersionUID = 1098346940;
    ...
    /**
     * Setter for <code>streamdb.stream.logtag_id</code>.
     */
    ...
    /**
     * Getter for <code>streamdb.stream.logtag_id</code>.
     */
    ...
    @Override
    public Row6<UInteger, UInteger, String, String, String, ULong> valuesRow() {
    ...
    public Field<ULong> field6() {
        return Stream.STREAM.LOGTAG_ID;
    }
    ...
    @Override
    public StreamRecord value6(ULong value) {
        setLogtagId(value);
        return this;
    }

    @Override
    public StreamRecord values(UInteger value1, UInteger value2, String value3, String value4, String value5, ULong value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public StreamRecord(UInteger id, UInteger gid, String directory, String stream, String tag, ULong logtagId) {
        super(Stream.STREAM);
